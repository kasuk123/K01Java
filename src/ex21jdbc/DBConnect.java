...
public class DBConnect {
	...
	public static void main(String[] args) {
		try {
			/*
			 * JDBC프로그래밍 절차
			 1]오라클용 JDB드라이버를 메모리에 로드
			 	:new를 사용하지 않고 클래스명으로 직접 찾아서 객체생성후
			 	메모리에 로드하는 forName()을 사용한다. 메모리에 도르된 
		...
		/*
		 ...
		 커넥션URL =>
		 	jdbc:oracle:thin:@IP주소:토프번호:SID
		...
		if(con!=null) {
			...
			/*
			 ...
			 사용한다. 해당 객체는 주로 정적쿼리를 실행할 때 사용된다.
			 */
			...
			while(rs.next()) {
				/*
				 ...
				 생성되어 있다. 인자값으로는 컬럼의 순서에 따른 인덱스를
				 쓸 수도 있고, 컬럼명을 쓸 수도 있따.
				 */
