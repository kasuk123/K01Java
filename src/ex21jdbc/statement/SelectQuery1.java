...
public class SelectQuery1 extends ConnectDB {
 ...
 */
	...
	public	void execute() {
		try {
			...
			while(rs.next()) {
				String id = rs.getNString(1);//id컬럼
				String pw = rs.getNString("pass");
				...
				System.out.printf("%-10s %-10s %-13s %-20s %s %s\n",
	...
	public static void main(String[] args) {
		SelectQuery1 selectQuery1 = new SelectQuery1();
